"""
CRM Vitale — Django Views
==========================
Analytics views with Plotly charts, integrated into ALIA project.
"""
...
def zones(request):
    ...
    return render(request, "crm/zones.html", context)
...
def delegates(request):
    ...
    return render(request, "crm/delegates.html", context)
...
def pharmacies(request):
    ...
    return render(request, "crm/pharmacies.html", context)
...
def predictions(request):
    try:
        ...
        context = {"page": "crm", "model_ready": False}

    return render(request, "crm/predictions.html", context)
...
def overview_pdf(request):
    ...
    # build_overview_ai now returns a dict with 'summary_text' and 'analytics'
    report_data = build_overview_ai(
    ...
    pdf = generate_pdf(
        "CRM Vitale — Executive Dashboard Report",
        data,
        report_data,
    )

    response = HttpResponse(pdf, content_type="application/pdf")
    response["Content-Disposition"] = 'attachment; filename="crm_vitale_report.pdf"'
